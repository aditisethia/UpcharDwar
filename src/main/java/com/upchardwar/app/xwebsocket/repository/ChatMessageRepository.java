...
public interface ChatMessageRepository extends CrudRepository<ChatMessage, String> {
	...
	@Query("SELECT c FROM ChatMessage c WHERE( c.senderId =:senderId AND c.recipientId =:recipientId  )  OR ( c.recipientId =: senderId AND c.senderId =:recipientId    )ORDER BY c.timestamp DESC  ")
